        ...
        <div class="project-card">
            <div class="project-img-container">
                <?php if ($project['image_url']): ?>
                    <img src="<?= UPLOAD_URL . $project['image_url'] ?>" alt="<?= htmlspecialchars($project['title']) ?>" class="project-img">
                <?php else: ?>
                    <div style="width:100%;height:100%;background:var(--bg-alt);display:flex;align-items:center;justify-content:center;color:var(--text-muted)">Pas d'image</div>
                <?php endif; ?>
            </div>
            <div class="project-info">
                ...
                <?php endif; ?>
                <?php if ($project['link']): ?>
                <a href="<?= htmlspecialchars($project['link']) ?>" target="_blank" class="project-link" style="margin-top:auto">Voir →</a>
                <?php endif; ?>
            </div>
        </div>
        <?php endforeach; ?>
